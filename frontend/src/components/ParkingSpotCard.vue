<template>
  <ion-card class="parking-spot-card" :class="['parking-spot-card-rank-'+spot.rankTime]" @click="$emit('spot-selected', spot)" button>
    <div class="absolute flex" style="top: .3em; right: .3em; z-index: 100;">
      <ion-text color="info" style="margin-left: auto; margin-right: 0;"><Info :size="18" /></ion-text>
    </div>
    ...
    <ion-card-content>
      ...
      <div class="flex ion-align-center ion-justify-content-center">
